...
const TOKEN = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Im5hc3RhbWFuenVrNjJAZ21haWwuY29tIiwiaWF0IjoxNzYzNjU2MDE0fQ.DN0FnEl-e-zrUtO3fVjYcp7plfndNEip_BSIT9P9WuU");
const fetchNotes = async (page = 1, search = '', perPage = 12, tag)=>{
    const params = {
        page,
        search,
        perPage
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes`, {
        params,
        headers: {
...
const createNote = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/notes`, data, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
const deleteNote = async (id)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/notes/${id}`, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
async function fetchNoteById(noteId) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes/${noteId}`, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
function NoteList(t0) {
    ...
    if ($[0] !== "834eb846bae398939e087e49583530db54823211e829b9c975afbd41789d7223") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "834eb846bae398939e087e49583530db54823211e829b9c975afbd41789d7223";
    }
    const { notes } = t0;
    ...
    const deleteNoteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(t2);
    let t3;
    if ($[4] !== deleteNoteMutation || $[5] !== deletingId || $[6] !== notes) {
        let t4;
        if ($[8] !== deleteNoteMutation || $[9] !== deletingId) {
            t4 = ({
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        onClick: {
                                            "NoteList[notes.map() > <button>.onClick]": ()=>deleteNoteMutation.mutate(note.id)
                                        }["NoteList[notes.map() > <button>.onClick]"],
                                        children: deletingId === note.id ? "Deleting..." : "Delete"
                                    }, void 0, false, {
                                        fileName: "[project]/components/NoteList/NoteList.tsx",
                                        lineNumber: 56,
                                        columnNumber: 244
...
_s(NoteList, "Zzpi4fG6OnbbXbsGL8jP/nBodxw=", false, function() {
    return [
...
"[project]/components/hooks/useModalControl.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useModalControl() {
    ...
    if ($[0] !== "0e6966ac1be4cf631ec5073caeabd5e3f84333b50965c031da54f3b734747d58") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "0e6966ac1be4cf631ec5073caeabd5e3f84333b50965c031da54f3b734747d58";
    }
    const [isModalOpen, setIsModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ({
            "useModalControl[openModal]": ()=>setIsModalOpen(true)
        })["useModalControl[openModal]"];
        $[1] = t0;
    } else {
        t0 = $[1];
    }
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "useModalControl[closeModal]": ()=>setIsModalOpen(false)
        })["useModalControl[closeModal]"];
        $[2] = t1;
    } else {
        t1 = $[2];
    }
...
_s(useModalControl, "mLsII5HRP5G63IA/8vjZ5YHXWr8=");
const __TURBOPACK__default__export__ = useModalControl;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function SearchBox(t0) {
    ...
    if ($[0] !== "159748c536eca563fc9b07e1832b293276bea2fea4e44fe9f2b71e69e31adcf4") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "159748c536eca563fc9b07e1832b293276bea2fea4e44fe9f2b71e69e31adcf4";
    }
    const { search, onChange } = t0;
    let t1;
    if ($[1] !== onChange) {
        t1 = ({
    ...
    if ($[3] !== search || $[4] !== t1) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            ...
            className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SearchBox$2f$SearchBox$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].searchInput,
            onChange: t1
        }, void 0, false, {
...
function Modal(t0) {
    ...
    if ($[0] !== "799d3c0e6b76cf2771c7c4cde2e34749526fcce3e7638c53fe55ac3f9b61346f") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "799d3c0e6b76cf2771c7c4cde2e34749526fcce3e7638c53fe55ac3f9b61346f";
    }
    ...
    if ($[6] !== onClose) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            type: "button",
            className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Modal$2f$Modal$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].closeBtn,
            onClick: onClose,
            children: "×"
        }, void 0, false, {
    ...
    let t6;
    if ($[11] !== handleBackdropClick || $[12] !== t5) {
...
const validationSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().min(3, 'Min 3 characters').max(50, 'Max 50 characters').required('Required'),
...
function NoteForm({ onCancel }) {
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "NoteForm.useMutation[mutation]": (data)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNote"])(data)
        ...
        children: ({ isSubmitting })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Form"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("fieldset", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteForm$2f$NoteForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].fieldset,
                        children: [
...
_s(NoteForm, "6gCcaDFNuB89cwNBYfNTywIu0+0=", false, function() {
    return [
...
function Pagination(t0) {
    ...
    if ($[0] !== "52b456515ac454c2b82e0d452655b89294ed131c8f16f3eb82c9cc14e1794640") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "52b456515ac454c2b82e0d452655b89294ed131c8f16f3eb82c9cc14e1794640";
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useModalControl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/hooks/useModalControl.ts [app-client] (ecmascript)");
...
function NotesClient(t0) {
    ...
    if ($[0] !== "8e27d646c145ad58691165c0da42b0b9b08029305f1a1bed279859f1e39c89b3") {
        for(let $i = 0; $i < 40; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8e27d646c145ad58691165c0da42b0b9b08029305f1a1bed279859f1e39c89b3";
    }
    const { dehydratedState, tag, initialPage: t1, initialSearch: t2 } = t0;
    const initialPage = t1 === undefined ? 1 : t1;
    const initialSearch = t2 === undefined ? "" : t2;
    const [search, setSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialSearch);
    ...
    const createNoteModal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useModalControl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "NotesClient[handleSearchChange]": (value)=>{
                setSearch(value);
                setPage(1);
            }
        })["NotesClient[handleSearchChange]"];
        $[1] = t3;
    } else {
        t3 = $[1];
    }
    const handleSearchChange = t3;
    const t4 = tag ?? "all";
    let t5;
    if ($[2] !== debouncedSearch || $[3] !== page || $[4] !== t4) {
        t5 = [
            "notes",
            t4,
            debouncedSearch,
    ...
    let t6;
    if ($[6] !== debouncedSearch || $[7] !== page || $[8] !== tag) {
        t6 = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNotes"])(page, debouncedSearch, 12, tag);
        $[6] = debouncedSearch;
        $[7] = page;
        $[8] = tag;
        $[9] = t6;
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t7);
    let t8;
    if ($[13] !== search) {
    ...
    let t10;
    if ($[18] !== createNoteModal.openModal) {
    ...
    let t12;
    if ($[24] !== isLoading) {
        t12 = isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$Notes$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].loading,
    ...
    if ($[29] !== createNoteModal.closeModal || $[30] !== createNoteModal.isModalOpen) {
        ...
        $[29] = createNoteModal.closeModal;
        $[30] = createNoteModal.isModalOpen;
        $[31] = t14;
    } else {
        t14 = $[31];
    }
    let t15;
    if ($[32] !== t11 || $[33] !== t12 || $[34] !== t13 || $[35] !== t14) {
...
_s(NotesClient, "L7tzbCl2X//yzlCZnugMjii5MFw=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$useModalControl$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
//# sourceMappingURL=_64db1ac6._.js.map