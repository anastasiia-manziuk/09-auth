...
const fetchNotes = async (page = 1, search = '', perPage = 12, tag)=>{
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes`, {
        params,
        headers: {
...
const createNote = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/notes`, data, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
const deleteNote = async (id)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/notes/${id}`, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
async function fetchNoteById(noteId) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes/${noteId}`, {
        headers: {
            Authorization: `Bearer ${TOKEN}`
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__520ae4cb._.js.map